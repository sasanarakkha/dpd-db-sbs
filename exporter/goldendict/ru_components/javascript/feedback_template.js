function feedbackTemplate(data, progName) {
    ...
    <div class="tertiary">
        ...
        <br>
        Словарь является частичным переводом <a class="dpd-link" href="https://digitalpalidictionary.github.io/">DPD</a> - <b>Электронный Словарь Пали (от Дост. Бодхираса).</b>
        <br>
        ...
        Заметили ошибку? <a class="dpd-link" href="https://docs.google.com/forms/d/1iMD9sCSWFfJAFCFYuG9HRIyrr9KFRy0nAOVApM998wM/viewform?usp=pp_url&entry.438735500=${lemmaLink}&entry.326955045=Грамматика&entry.1433863141=${progName}+${data.date}" target="_blank">Исправьте здесь</a>.
        <span>
        ...
        <a class="dpd-link" href="https://devamitta.github.io/dpd.rus/">Читать документацию</a>.
        <span>
            Узнайте как установить и настроить словарь на разные платформы, как умело использовать весь функционал словаря и как обновить, чтобы иметь самую свежую версию.
        </span>
        <br><br>

        <a class="dpd-link" href="mailto:devamitta@sasanarakkha.org">Помощь проекту</a><span>. Если вы программист или хорошо знаете Пали или как-то хотите поддержать проект, помощь приветствуется!</span>
        <br><br>

        При поддержке <a class="dpd-link" href="https://sasanarakkha.org/">Sāsanārakkha Buddhist Sanctuary</a>.
    </div>
    `
    return html
}