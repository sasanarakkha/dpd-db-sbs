function makeFeedback(data) {
    ...
    <p>
        ...
        <br>
        Словарь является частичным переводом <a class="link" href="https://digitalpalidictionary.github.io/">DPD</a> - <b>Электронный Словарь Пали (от Дост. Бодхираса).</b>
        <br>
    ...
    <p>
        Заметили ошибку? <a class="link" href="https://docs.google.com/forms/d/1iMD9sCSWFfJAFCFYuG9HRIyrr9KFRy0nAOVApM998wM/viewform?usp=pp_url&entry.438735500=${lemmaLink}&entry.326955045=Грамматика&entry.1433863141=${progName}+${data.date}" target="_blank">Исправьте здесь</a>.
        <span>
    ...
    <p>
        <a class="link" href="https://devamitta.github.io/dpd.rus/">Читать документацию</a>.
        <span>
    ...
    <p>
        <a class="link" href="mailto:devamitta@sasanarakkha.org">Помощь проекту</a><span>. Если вы программист или хорошо знаете Пали или как-то хотите поддержать проект, помощь приветствуется!</span>
    </p>
    <p>
