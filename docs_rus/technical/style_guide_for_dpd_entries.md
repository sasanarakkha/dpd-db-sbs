...
- Refer to the possibilities outlined in [tools/pos.py](https://github.com/sasanarakkha/dpd-db-sbs/blob/main/tools/pos.py){target="_blank"}
...
- See [explicit guide](https://github.com/sasanarakkha/dpd-db-sbs/blob/main/db/db/sanskrit/sanskrit_style_guide.md){target="_blank"}
...
- All patterns can be found in the [inflection_templates.xlsx](https://github.com/sasanarakkha/dpd-db-sbs/raw/main/db/inflections/inflection_templates.xlsx){target="_blank"}
