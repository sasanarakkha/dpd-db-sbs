    ...
    for sbs_class in range(2, 30):
        ...
        with open(filename, "w", encoding="utf-8") as f:
            ...
            for word in words:
                ...
                construction = (
                    word.construction_line1.replace("|", "\\|")
                    if word.construction_line1
                    else ""
                )
                ...
                f.write(
                    f"| {pali} | {pos} | {meaning} | {root} | {construction} | {pattern} | {word.sbs.sbs_class} |\n"
                )
    ...
    try:
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            ...
            for row in rows:
                ...
                f.write(
                    f"| {abbrev} | {meaning} | {pali} | {example} | {explanation} |\n"
                )
