...
downloads_dir: Path = deva_dir / "Downloads" / "Pali_classes" # e.g., /Users/deva/Downloads/Pali_classes

materials_dir: Path = deva_dir / "filesrv1" / "share1" / "Sharing between users" / "13 For Pāli class" / "offline materials"
beginner_dir: Path = materials_dir / "beginner"
intermediate_dir: Path = materials_dir / "intermediate"

beginner_docs_src: Path = downloads_dir / "beginner_pali_course_docx.zip"
...
if beginner_docs_src.exists():
   ...
   print(f"\033[1;31m {beginner_docs_src} is missing. Cannot proceed with unziping. \033[0m")
...
if beginner_pdfs_src.exists():
   ...
   print(f"\033[1;31m {beginner_pdfs_src} is missing. Cannot proceed with unziping. \033[0m")
...
if intermediate_docs_src.exists():
   ...
   # Print completion message in green color
   print("\033[1;32m intermediate_docs_src has been unpacked to the server folder \033[0m")
else:
   print(f"\033[1;31m {intermediate_docs_src} is missing. Cannot proceed with unziping. \033[0m")
...
if intermediate_pdfs_src.exists():
   ...
   with ZipFile(intermediate_pdfs_src, 'r') as zipObj:
      ...
      zipObj.extractall(intermediate_dir)
   # Print completion message in green color
   print("\033[1;32m intermediate_pdfs_src has been unpacked to the server folder \033[0m")
else:
   print(f"\033[1;31m {intermediate_pdfs_src} is missing. Cannot proceed with unziping. \033[0m")
