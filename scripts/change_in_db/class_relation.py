...
def determine_sbs_class(word) -> Optional[int]:
    ...
    if word.lemma_2 in with_part and word.pos == "ind" and "prep" in word.grammar:
        # print(f"Pattern: with_part, Word: {word.lemma_1}")
        return 5

    if word.lemma_2 in conj_part and word.pos == "ind" and "emph" not in word.grammar:
    ...
    if (
        ...
        if (
            ...
            # filter until-then
                ...
                word.lemma_2 in adv_until_then
                and word.pos == "ind"
                and ", adv" in word.grammar
            ):
                # print(f"Pattern: until-then, Word: {word.lemma_1}")
    ...
    if (
        ...
        and "compar" not in word.grammar
        and word.compound_type == ""
        and any(pattern in word.phonetic for pattern in vowel_sandhi_patterns)
    ):
    ...
    if (
        ...
        and "compar" not in word.grammar
        and word.compound_type == ""
        and any(pattern in word.phonetic for pattern in cons_patterns)
    ):
