...
safe_copy_file "Pali Patimokkha Word By Word.apkg" "$TEMP_PUSH_DEST_DIR/patimokkha-word-by-word.apkg"
safe_copy_file "Pātimokkha Word by Word.xlsx" "$FILESRV_PAT_DIR/Pātimokkha Word by Word.xlsx" "-X -f"
safe_copy_file "Пали Словарь.apkg" "$FILESRV_DEST_BASE_DIR/Пали Словарь Анки/ru-pali-vocab.apkg" "-X -f"
safe_copy_file "Пали Словарь.apkg" "$TEMP_PUSH_DEST_DIR/ru-pali-vocab.apkg" "-X -f"
safe_copy_file "SBS Pali-English Vocab.apkg" "$FILESRV_DEST_BASE_DIR/SBS Pāli-English Vocab/sbs-pali-english-vocab.apkg" "-X -f"
safe_copy_file "SBS Pali-English Vocab.apkg" "$TEMP_PUSH_DEST_DIR/sbs-pali-english-vocab.apkg" "-X -f"
safe_copy_file "Pali DHP vocab.apkg" "$FILESRV_DEST_BASE_DIR/DHP vocab/dhp-vocab.apkg" "-X -f"
safe_copy_file "Pali DHP vocab.apkg" "$TEMP_PUSH_DEST_DIR/dhp-vocab.apkg" "-X -f"
safe_copy_file "Pali Parittas.apkg" "$FILESRV_DEST_BASE_DIR/Parittas/parittas.apkg" "-X -f"
safe_copy_file "Pali Parittas.apkg" "$TEMP_PUSH_DEST_DIR/parittas.apkg" "-X -f"
...
safe_copy_file "Pali Bhikkhu Vibhanga.apkg" "$TEMP_PUSH_DEST_DIR/vibhanga.apkg" "-X -f"
