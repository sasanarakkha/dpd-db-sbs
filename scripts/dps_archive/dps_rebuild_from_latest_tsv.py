...
"""Rebuild the databse from scratch from latest files in db/backup_sbs_ru folder. Modfied copy of https://github.com/digitalpalidictionary/dpd-db/blob/main/scripts/db_rebuild_from_tsv.py"""
...
def main():
    pr.tic()
    console.print("[bold bright_yellow]rebuilding db from db/backup_sbs_ru/*.tsvs")
