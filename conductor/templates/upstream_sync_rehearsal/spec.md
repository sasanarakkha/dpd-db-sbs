...
4.  **Shadow Copy Maintenance:** Update localized "shadow" copies (`*_ru.py`, `*_sbs.py`, etc.) if their original upstream sources have received significant updates.
...
-   Manual merges for `db/models.py`, `gui2/main.py`, and other critical files are performed according to the Guide.
-   All shadow copies are updated to reflect relevant upstream logic.
