...
- [ ] Task: Make use of `tests/test_ai_pali_translate.py` to test the "Safe Merge" logic (mocking the AI response).
- [ ] Task: Make use of `exporter/mcp/ai_pali_translate.py` to implement the "Safe Merge" pattern:
...
- [ ] Task: Make use of the `AnalysisView` in `gui2/analysis_view.py` building upon the existing draft, with the main layout: Input, Sutta Selector, Analysis Table.
