...
dps_field_mapping = {
    ...
    "dps_lemma_1": {
        ...
        "params": create_params({"disabled": False}),
    },
    "dps_grammar": {
        "control": ft.TextField,
        "params": create_params({"disabled": False}),
    ...
    "dps_meaning": {
        "control": ft.TextField,
        "params": create_params({"multiline": True, "min_lines": 2, "disabled": False}),
    },
    "dps_suggestion": {
        "control": ft.TextField,
        "params": create_params({"multiline": True, "min_lines": 3}),
    },
    "dps_ru_meaning": {
        "control": DpsMeaningField,
    ...
    "dps_ru_meaning_lit": {
        "control": DpsMeaningField,
        "params": create_params({"tooltip": "type Russian literal meaning"}),
    },
    "dps_ru_cognate": {
        "control": ft.TextField,
        "params": create_params({"tooltip": "Russian word which close sounding"}),
    },
    "dps_sbs_meaning": {
        "control": ft.TextField,
        "params": create_params(
            {"multiline": True, "min_lines": 2, "tooltip": "type meaning in SBS PER"}
        ),
    },
    ...
    "dps_notes": {
        "control": ft.TextField,
        "params": create_params({"multiline": True, "min_lines": 3, "disabled": False}),
    },
    "dps_notes_suggestion": {
        "control": ft.TextField,
        "params": create_params({"multiline": True, "min_lines": 2}),
    },
    "dps_ru_notes": {
        "control": ft.TextField,
        "params": create_params({"multiline": True, "min_lines": 2}),
    ...
    "dps_example_1": {
        ...
        "params": create_params({"multiline": True, "min_lines": 5, "disabled": False}),
    },
    "dps_source_2": {
        "control": ft.TextField,
        "params": create_params({"disabled": False}),
    ...
    "dps_sbs_source_1": {
        "control": ft.TextField,
        "params": create_params({"tooltip": "Sutta code using DPR system"}),
    },
    "dps_sbs_sutta_1": {
        "control": ft.TextField,
        "params": create_params({"tooltip": "Sutta name"}),
    },
    "dps_sbs_example_1": {
        "control": DpsExampleField,
        "params": create_params({"multiline": True, "min_lines": 4}),
    },
    ...
    "dps_meaning_1": {
        "control": ft.TextField,
        "params": create_params({"disabled": True, "visible": False}),
    },
    "dps_pos": {
        "control": ft.TextField,
        "params": create_params({"disabled": True, "visible": False}),
