...
dps_field_mapping = {
    ...
    "dps_class_extra": {"control": ft.Dropdown, "params": create_params({"options": [ft.dropdown.Option(""), ft.dropdown.Option("extra")], "tooltip": "select 'extra' for extra examples"})},
    "dps_class_anki": {"control": ft.TextField, "params": create_params({"tooltip": "which class from Anki deck for Pāli Class"})},
