...
class DpsMeaningField(ft.Column):
    def __init__(
        self,
        ui,
        field_name,
        dps_fields,
        spellchecker: RuSpellChecker,
        on_focus=None,
        on_change=None,
        on_submit=None,
        on_blur=None,
        ...
        # Field to add words to the Russian dictionary
        self.add_to_dict_field = ft.TextField(
            label="Add Russian spelling ",
    ...
    def _handle_add_to_dict_submit(self, e: ft.ControlEvent):
        ...
        if word_to_add:
            message = self.spellchecker.add_to_ru_dictionary(word_to_add)
    ...
    def _handle_spell_check(self, e: ft.ControlEvent):
        """Common logic for spell checking the Russian meaning field."""
        field = e.control
        value = field.value
